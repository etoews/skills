...
class RunConfig:
    ...
    )  # extra params forwarded to LiteLLM
    ...
    def description(self) -> str:
        ...
        bits.append(
            "offline stub (scores not meaningful)"
            if self.offline
...
def _coerce(value: str) -> Any:
    """Coerce a --param value.

    Parsed as JSON if it parses (int/float/bool/null/list), else kept as str.
    """
    try:
